...
class Sasana(models.Model):
    ...
    no_wa_ketua = models.IntegerField()
    nama_pengurus = models.CharField(max_length=255)
    no_wa_pengurus = models.IntegerField()
...
class Instruktur(models.Model):
    ...
    file_sertifikat = models.FileField(upload_to='sertifikasi_instruktur/')
